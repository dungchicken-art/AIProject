...
1. Cài đặt môi trường Python và phụ thuộc:
   ...
   ```
   - Có thể bỏ qua OSMnx nếu không cần tải graph online; file `.graphml` (nếu có) sẽ được đọc bằng NetworkX thuần.
   - Nếu thiếu cả OSMnx lẫn file graphml, app sẽ tự fallback sang đồ thị lưới dày hơn (14x14) nằm đúng tọa độ khu vực Khương Đình để bạn vẫn thấy nhiều node trên bản đồ.
